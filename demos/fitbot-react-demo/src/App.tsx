...
function App() {
    ...
    return (
        <div className="container" style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="card" style={{ padding: '2rem', border: '1px solid #ccc', borderRadius: '8px', backgroundColor: '#f9f9f9', color: '#000' }}>
                ...
                <input
                    ...
                    style={{ width: '100%', padding: '0.75rem', fontSize: '1rem', borderRadius: '4px', border: '1px solid #ccc', marginBottom: '1rem', color: '#000' }}
                />

                {apiKey ? (
                    <div style={{ padding: '1rem', backgroundColor: '#e6ffe6', borderLeft: '4px solid #00cc00', borderRadius: '4px', color: '#000' }}>
                    ...
                    <div style={{ padding: '1rem', backgroundColor: '#fff3cd', borderLeft: '4px solid #ffc107', borderRadius: '4px', color: '#000' }}>
